...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-2">
        <h3 class="h3 fw-medium">Sửa môn học</h3>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item fw-medium active" aria-current="page">Sửa</li>
            </ol>
        </nav>
    </div>
    <div class="row g-0">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="formInformation" method="POST" action="{{ route('eduProgram.update') }}"
                        class="d-flex flex-column gap-2">
                        @csrf
                        <div class="d-flex gap-2">
                            <div class="form-group" style="flex: 1">
                                <label for="Id_Sub" class="form-label">Mã môn học</label>
                                <input type="text" name="Id_Sub" id="Id_Sub"
                                    class="form-control{{ $errors->has('Id_Sub') ? ' is-invalid' : '' }}"
                                    value="{{ $subject->Id_Sub }}" placeholder="Nhập mã môn học" readonly>
                                <span class="text-danger">
                                    @if ($errors->has('Id_Sub'))
                                        {{ $errors->first('Id_Sub') }}
                                    @endif
                                </span>
                            </div>
                            <div class="form-group" style="flex: 1">
                                ...
                                <input type="text" name="Sym_Sub" id="Sym_Sub"
                                    ...
                                    value="{{ $subject->Sym_Sub }}" placeholder="Nhập ký hiệu môn học" tabindex="1">
                                <span class="text-danger">
                            ...
                            <div class="form-group" style="flex: 1">
                                ...
                                <input type="text" name="Name_Sub" id="Name_Sub"
                                    ...
                                    value="{{ $subject->Name_Sub }}" placeholder="Nhập tên môn học" tabindex="2">
                                <span class="text-danger">
                        ...
                        <div class="d-flex gap-4">
                            <div class="form-group" style="flex: 1">
                                ...
                                <input type="number" name="Theory" id="Theory"
                                    ...
                                    value="{{ $subject->Theory }}" min="0" tabindex="3">
                                <span class="text-danger">
                            ...
                            <div class="form-group" style="flex: 1">
                                ...
                                <input type="number" name="Exercise" id="Exercise"
                                    ...
                                    value="{{ $subject->Exercise }}" min="0" tabindex="4">
                                <span class="text-danger">
                            ...
                            <div class="form-group" style="flex: 1">
                                ...
                                <input type="number" name="Practice" id="Practice"
                                    ...
                                    value="{{ $subject->Practice }}" min="0" tabindex="5">
                                <span class="text-danger">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#saveBtn").on('click', function() {
                ...
                $("#formInformation").find(".form-control").each(function(element) {
                    if ($(this).val() == "") {
                        isValid = false;
