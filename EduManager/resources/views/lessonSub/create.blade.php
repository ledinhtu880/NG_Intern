...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-2">
        <h3 class="h3 fw-medium">Thêm chương trình học</h3>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('eduProgram.index') }}" class="text-decoration-none fw-medium">Quản lý chương trình
                        học</a>
                </li>
            ...
            <div class="card">
                ...
                <div class="card-footer pt-0 border-0 bg-transparent">
                    <div class="d-flex justify-content-end gap-3">
                        <a href="{{ route('lessonSub.index') }}" class="btn btn-secondary" tabindex="10">Quay lại</a>
