...
Route::middleware('checklogin')->group(function () {
  ...
  Route::group(['prefix' => 'orderLocals', 'as' => 'orderLocals.'], function () {
    Route::group(['prefix' => 'makes', 'as' => 'makes.'], function () {
      ...
      Route::get('edit/{id}/addSimple', [OrderLocalController::class, 'addSimples'])->name('addSimple');
      Route::post('storeSimple', [OrderLocalController::class, 'storeSimples'])->name('storeSimple');
