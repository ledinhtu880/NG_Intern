      ...
      <div class="card mt-3">
        ...
        <div class="card-body px-0">
          <div class="ms-3 my-3" style="width: 300px;">
            <label for="FK_Id_StationType" class="form-label">Chọn loại trạm</label>
            <select id="FK_Id_StationType" name="FK_Id_StationType" class="form-select" style="width: 540px">
              @foreach ($station_types as $station_type)
              <option value="{{ $station_type->Id_StationType }}">{{ $station_type->Name_StationType }}</option>
              @endforeach
            </select>
          </div>
