...
@section('title', 'Quản lý đơn sản xuất và giao hàng')
    ...
    <div class="col-md-12">
      <div class="card mt-3">
        <div class="card-header p-0 overflow-hidden">
          <h4 class="card-title m-0 bg-primary-color p-3">Quản lý đơn sản xuất và giao hàng</h4>
          <div class="d-flex align-items-center justify-content-between my-3 px-3">
            <a href="{{ route('makesOrExpeditions.create')}}" class="btn btn-primary-color text-white p-2 w-25">
              Thêm đơn sản xuất thùng hàng
            </a>
            <a href="{{ route('orders.create')}}" class="btn btn-primary-color text-white p-2 w-25">
              Thêm đơn giao hàng
            </a>
          </div>
        </div>
        <div class="card-body px-0">
          <table class="table table-striped w-100">
            ...
            <tbody id="table-data" class="table-group-divider">
              ...
              <tr>
                <td class="text-center">{{ $each->Id_OrderMakeOrExpedition }}</td>
                ...
                <td class="text-center">{{ $each->start_date }}</td>
