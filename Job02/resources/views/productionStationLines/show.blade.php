          ...
          <div class="card-body d-flex flex-column justify-content-between h-100">
            <div class="row">
              <div class="col-md-6 mb-4">
                ...
                <h6 class="h6 text-muted">{{ $productionStationLine->Name_ProdStationLine }}</h6>
              </div>
              <div class="col-md-6 mb-4">
              ...
              <div class="col-md-6 mb-4">
                ...
                <h6 class="h6 text-muted">{{ $productionStationLine->Description }}</h6>
              </div>
              <div class="col-md-6 mb-4">
                <h5 class="h5 fw-medium mb-1">Loại</h5>
                <h6 class="h6 text-muted">{{ $productionStationLine->orderType->Name_OrderType }}</h6>
              </div>
              {{-- <div class="col-md-6 mb-4">
