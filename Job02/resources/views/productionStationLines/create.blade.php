            ...
            <form method="POST">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  {{-- @if ($errors->has('Station_End'))
                  <span class="text-danger" id="Station_End_Err">
                    {{ $errors->first('Station_End') }}
                  </span>
                  @endif --}}
                </div>
              </div>
