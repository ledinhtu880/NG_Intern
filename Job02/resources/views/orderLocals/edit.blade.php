      ...
      <div class="w-100">
              ...
              <div class="row">
                ...
                <div class="col-md-4 mb-3">
                  <div class="input-group">
                    ...
                    <input type="date" class="form-control" id="DateDilivery" name="DateDilivery"
        ...
        <div class="card">
          ...
          <div class="card-footer d-flex align-items-center justify-content-between gap-2">
            <a href="{{  route('orderLocals.addSimple', $orderLocal) }}" class="btn btn-primary-color">
              Thêm thùng hàng
            </a>
...
@push('javascript')
<script src="{{ asset('js/orderLocals/edit.js') }}"></script>
@endpush