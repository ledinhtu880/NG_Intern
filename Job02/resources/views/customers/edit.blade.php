        ...
        <div class="w-50 ">
          <div class="card">
            <div class="card-header p-0 overflow-hidden">
              <h3 class="card-title m-0 bg-primary-color p-3 text-white">Sửa khách hàng</h3>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select name="FK_Id_Mode_Transport"
                    ...
                    @foreach ($data as $each)
                      <option value="{{ $each->Id_ModeTransport }}" @if ($each->Id_ModeTransport == $customer->FK_Id_Mode_Transport) selected @endif>
