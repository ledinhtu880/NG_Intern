                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <h6 class="card-subtitle" style="font-weight: 600;">Tên dây chuyền</h5>
                                <p class="card-text text-secondary fw-normal">
                                    {{ $productStationLine->Name_ProdStationLine }}
                            </h6>
                        </div>
                        <div class="col-md-6 mb-3">
                            <h6 class="card-subtitle" style="font-weight: 600;">Tên trạm</h5>
                                <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <h6 class="card-subtitle" style="font-weight: 600;">Mô tả</h5>
                                <p class="card-text text-secondary fw-normal">{{ $productStationLine->Description }}
                            </h6>
                        </div>
                        <div class="col-md-6 mb-3">
                            <h6 class="card-subtitle" style="font-weight: 600;">Loại</h5>
                                <p class="card-text text-secondary fw-normal">
                                    {{ $productStationLine->orderType->Name_OrderType }}
                            </h6>
                        </div>
                    </div>
                </div>
