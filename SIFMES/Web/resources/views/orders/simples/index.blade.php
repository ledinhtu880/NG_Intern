        ...
        <div class="col-md-12">
            <div class="card py-3 gap-3">
                <div class="card-header px-3 py-0 border-0 bg-transparent">
                    <a href="{{ route('orders.simples.create') }}" class="btn btn-main">
                            ...
                            @foreach ($data as $each)
                                <tr class="align-middle">
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="{{ route('orders.simples.show', $each) }}" class="btn btn-sm btn-outline">
                                            <i class="fa-solid fa-eye"></i>
                                        </a>
                                        <a href="{{ route('orders.simples.edit', $each) }}" class="btn btn-sm btn-outline">
