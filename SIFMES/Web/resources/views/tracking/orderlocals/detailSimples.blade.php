                    ...
                    <div class="card gap-3">
                        @if ($simple->progress == 'Thùng hàng chưa được khởi động')
                            <div class="card-header border-0 bg-transparent">
                                <h2 class="text-center">Thùng hàng chưa được khởi động</h2>
                            </div>
                        @else
                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-center w-100">
                                                    <div class="progress h-100 position-relative">
                                                        ...
                                                        <div class="progress-bar" role="progressbar" aria-valuenow=""
                                                            {{ $simple->progress }} aria-valuemin="0" aria-valuemax="100"
                                    ...
                                    <table class="table" id="myTable">
                                        <thead class="table-heading">
                                            <tr class="align-middle">
                                                ...
                                                <th scope="col" class="py-2 text-truncate">Thời gian lưu tại trạm</th>
                                            </tr>
                                        </thead>
                                        <tbody id="table-data">
