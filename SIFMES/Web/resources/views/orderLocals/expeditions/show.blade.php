          ...
          <tbody id="table-data">
            ...
            <tr>
              ...
              <td class="text-center">
                {{ number_format($each->Price_Container, ($each->Price_Container == (int)$each->Price_Container) ? 0 :
                2, ',', '.') }}
              <td class="text-center">
                {{ number_format($each->Price_Container * $each->Count_Container, ($each->Price_Container ==
                (int)$each->Price_Container) ? 0 : 2, ',', '.') . ' VNĐ' }}
              </td>
            </tr>
            @endforeach
          </tbody>
