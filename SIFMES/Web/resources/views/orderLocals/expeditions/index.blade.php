        ...
        <div class="col-md-12">
            <div class="card py-3 gap-3">
                <div class="card-header px-3 py-0 border-0 bg-transparent">
                    <a href="{{ route('orderLocals.expeditions.create') }}" class="btn btn-main">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p class="m-0">Bạn chắc chắn muốn xóa đơn giao hàng này?</p>
                                                        <p class="m-0">
                                                            Việc này sẽ xóa đơn giao hàng vĩnh viễn. <br>
