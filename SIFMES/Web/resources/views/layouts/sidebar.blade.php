            ...
            <ul class="side-nav px-2">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="management-collapsed">
                        <ul class="btn-toggle-nav list-unstyled fw-normal d-flex flex-column gap-2">
                            <li><a class="text-decoration-none text-muted" href="{{ route('customers.index') }}">Quản lý
                                    khách
                                    hàng</a></li>
                            <li>
                            ...
                            <li><a class="text-decoration-none text-muted" href="{{ route('wares.index') }}">Quản lý kho
                                    hàng</a></li>
                            <li><a class="text-decoration-none text-muted" href="{{ route('stations.index') }}">Quản lý
                                    trạm</a></li>
                            <li>
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="local-collapsed">
                        <ul class="btn-toggle-nav list-unstyled fw-normal d-flex flex-column gap-2">
                            <li>
                                <a class="text-decoration-none text-muted"
                                    href="{{ route('orderLocals.makes.index') }}">Quản lý đơn
                                    sản xuất
                                </a>
                            </li>
                            <li>
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="tracking-collapsed">
                        <ul class="btn-toggle-nav list-unstyled fw-normal d-flex flex-column gap-2">
                            <li><a class="text-decoration-none text-muted" href="{{ route('tracking.orders.index') }}">
                                    Theo dõi đơn
                                    hàng
                                </a></li>
                            <li>
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="system-collapsed">
                        <ul class="btn-toggle-nav list-unstyled fw-normal d-flex flex-column gap-2">
                            <li><a class="text-decoration-none text-muted" href="{{ route('roles.index') }}">Quản lý
                                    vai trò</a></li>
                            <li>
