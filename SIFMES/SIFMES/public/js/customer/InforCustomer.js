    ...
    $("#customer_selected").change(function () {
        ...
        `;
                ...
                $.each(response.orders, function (index, value) {
                    ...
                    let Status =
                        Production_Status[count] * 100 == 100
                            ? "Đã hoàn thành"
                            : "Chưa hoàn thành";
                    let check = value.SimpleOrPack;
                    let route =
                        check == 0
                            ? `/tracking/customers/detailSimples/${Id_Order}`
                            : `/tracking/customers/detailPacks/${Id_Order}`;
            ...
            <tr>
              ...
              <td class="align-middle ">
                <div class="d-flex justify-content-center">
                  <div class="progress w-50 position-relative" role="progressbar" aria-valuenow="${
                      Production_Status[count] * 100
                  }" aria-valuemin="0"
                    aria-valuemax="100" style="height: 20px">
                    <div class="progress-bar bg-primary-color" style="width: ${
                        Production_Status[count] * 100
                    }%">
                    </div>
                    <span class="progress-text`;
                    if (Production_Status[count] * 100 >= 50)
                        htmls += ` text-white `;
