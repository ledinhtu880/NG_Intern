...
class OrderLocalController extends Controller
{
  ...
  public function showOrderByCustomerType(Request $request)
  {
    if ($request->ajax()) {
      ...
      $orders = DB::table('OrderLocal')
        ...
        ->join('ContentSimple', 'Id_ContentSimple', '=', 'FK_Id_ContentSimple')
        ...
        ->groupBy('Id_OrderLocal', 'Count', 'Date_Delivery', 'OrderLocal.SimpleOrPack', 'MakeOrPackOrExpedition', 'Date_Start', 'Date_Fin')
        ->select('OrderLocal.*')
        ->get();
      return response()->json([
        'status' => 'success',
  ...
  public function editMakes(string $id)
  {
    ...
    $data = DB::table('ContentSimple')
      ->select('Id_ContentSimple', 'FK_Id_RawMaterial', 'Name_RawMaterial', 'Count_RawMaterial', 'Unit',  'FK_Id_ContainerType', 'Name_ContainerType', 'Count_Container', 'Price_Container')
      ->join('RawMaterial', 'Id_RawMaterial', '=', 'FK_Id_RawMaterial')
      ->join('ContainerType', 'Id_ContainerType', '=', 'FK_Id_ContainerType')
      ->join('DetailContentSimpleOrderLocal', 'Id_ContentSimple', '=', 'FK_Id_ContentSimple')
      ->where('FK_Id_OrderLocal', '=', $id)
  ...
  public function showSimpleByCustomerTypePacks(Request $request)
  {
    ...
    $query = DB::table('Order')
      ...
      ->join('DetailContentSimpleOfPack', 'FK_Id_ContentPack', '=', 'Id_ContentPack')
      ->join('ContentSimple', 'FK_Id_ContentSimple', '=', 'Id_ContentSimple')
      ->join('ProcessContentSimple', 'FK_Id_ContentSimple', '=', 'Id_ContentSimple')
      ->join('DetailStateCellOfSimpleWareHouse', 'DetailStateCellOfSimpleWareHouse.FK_Id_ContentSimple', '=', 'Id_ContentSimple')
      ...
      ->groupBy('ContentPack.Id_ContentPack', 'Customer.Name_Customer', 'Count_Pack', 'Price_Pack', 'Order.Id_Order')
      ->select('ContentPack.Id_ContentPack', 'Customer.Name_Customer', 'Count_Pack', 'Price_Pack', 'Order.Id_Order')
      ->get();
    ...
    foreach ($query as $item) {
      $htmls .=
        ...
        <td class="align-middle text-center Id_ContentPack">' . $item->Id_ContentPack . '</td>
        ...
        <td class="align-middle text-center">' . $this->numberFormat($item->Price_Pack) . ' VNĐ' .
        '</td>
          </tr>
          ';
    }
  ...
  public function showOrderLocal(Request $request)
  {
    ...
    $result = DB::table('OrderLocal')
      ...
      ->groupBy('Id_OrderLocal', 'Count', 'Date_Delivery', 'OrderLocal.SimpleOrPack', 'MakeOrPackOrExpedition', 'Date_Start', 'Date_Fin')
      ->select('Id_OrderLocal', 'Count', 'Date_Delivery', 'OrderLocal.SimpleOrPack', 'MakeOrPackOrExpedition', 'Date_Start', 'Date_Fin')
      ->get();
  ...
  public function showDetailsPacks(string $Id_OrderLocal)
  {
    ...
    foreach ($ContentPack_Ids as $ContentPack_Id) {
      $ContentSimple_Ids[] = DetailContentSimpleOfPack::where('FK_Id_ContentPack', $ContentPack_Id)->pluck('FK_Id_ContentSimple')->toArray();
    }
  ...
  public function showExpeditions(string $id)
  {
    ...
    $data = $result = DB::table('DetailContentSimpleOfPack')
      ->join('ContentSimple', 'FK_Id_ContentSimple', '=', 'Id_ContentSimple')
      ->join('ContainerType', 'FK_Id_ContainerType', '=', 'Id_ContainerType')
      ->join('RawMaterial', 'FK_Id_RawMaterial', '=', 'Id_RawMaterial')
      ->select('Name_RawMaterial', 'Count_RawMaterial', 'Unit', 'Name_ContainerType', 'Count_Container', 'Price_Container')
