              ...
              <tbody>
                ...
                <tr>
                  <form action="" method="POST">
                    <input class="Id_ContentSimple" type="hidden" value="{{ $ContentSimple->Id_ContentSimple }}">
                    <td class="align-middle ">
                      <select class="form-select Id_RawMaterial">
                        @foreach ($materials as $material)
                        <option value="{{ $material->Id_RawMaterial }}" @if ($material->Id_RawMaterial ===
                          $ContentSimple->material->Id_RawMaterial) selected @endif>
                    ...
                    <td class="align-middle text-center RawMaterial_Unit">{{ $ContentSimple->material->Unit }}</td>
                    <td class="align-middle ">
                      <select class="form-select Id_ContainerType">
                        @foreach ($containerTypes as $containerType)
                        <option @if ($containerType->Id_ContainerType == $ContentSimple->FK_Id_ContainerType) selected
                    ...
                    <td class="align-middle ">
                      <button type="button" class="btn btn-sm btn-outline-light text-primary-color border-secondary"
                        data-bs-toggle="modal" data-bs-target="#deleteID-{{ $ContentSimple->Id_ContentSimple }}">
                        <i class="fa-solid fa-trash"></i>
                      </button>
                      <div class="modal fade" id="deleteID-{{ $ContentSimple->Id_ContentSimple }}" tabindex="-1"
  ...
  $(document).ready(function () {
    ...
    $('.btnDeleteSimple').click(function () {
      ...
      $.ajax({
        ...
        url: "/orders/packs/destroySimpleInPack/" + Id_ContentSimple,
