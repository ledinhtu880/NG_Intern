    ...
    <div class="col-md-12">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-color px-2 py-3 rounded">
          ...
          <li class="breadcrumb-item active" aria-current="page">Danh sách gói hàng tại kho 409</li>
        </ol>
      </nav>
      <div class="card my-3">
        ...
        if (response == 0) {
          ...
          for (var i = 1; i <= col * row; i++) {
            if (details[i - 1].FK_Id_StateCell == "0") {
              ...
              $('#cell' + i).attr("data-status", 0)
              $('#cell' + i).append(
                $(`<p class="small" data-id="${details[i - 1].FK_Id_ContentPack}"
                      id="pack-${details[i - 1].FK_Id_ContentPack}">Gói hàng số ${details[i - 1].FK_Id_ContentPack}
                    ...
                    <div class="modal-footer" style="height: 100px">
                      <div class="d-flex align-items-stretch justify-content-between w-100">
                          ...
                          <div class="d-flex gap-2">
                            ...
                            <button type="button" class="btn btn-primary-color btnTake" data-id="${details[i - 1].FK_Id_ContentPack}">Lấy gói hàng</button>
                          </div>
                      </div>
                    </div>
                  </div>
        ...
        success: function (response) {
          ...
          htmls += `<tr>
                      ...
                      <td class="text-center">
                        <button class="btn btn-sm btn-outline-light text-primary-color btnDetail border-secondary" data-bs-target="#showDetails-${data.Id_ContentPack}" 
          ...
          let modal = ` 
              <div class="modal fade" id="showDetails-${data.Id_ContentPack}" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl">
                  <div class="modal-content">
                    <div class="modal-header p-2 bg-primary-color text-start" data-bs-theme="dark">
                      <h5 class="modal-title w-100" id="show-${data.Id_ContentPack}Label">
