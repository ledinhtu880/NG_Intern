      ...
      <div class="w-100">
        ...
        <div class="card">
            ...
            <table class="table table-striped m-0">
              <thead>
                <tr>
                  ...
                  <th class="text-center" scope="col" width="170">Thành tiền</th>
                  <th class="text-center" scope="col" width="130">Trạng thái</th>
                  <th scope="col"></th>
                </tr>
              </thead>
              <tbody id="table-data">
                ...
                <tr class="js-row" data-id="{{ $each->Id_ContentSimple }}">
                  ...
                  <td class="text-center" data-id="Status" data-value="{{ $each->Status == 'Sản xuất mới' ? 0 : 1 }}">
                    {{ $each->Status}}
                  </td>
                  <td class="text-center">
          ...
          <div class="card-footer d-flex align-items-center justify-content-end gap-3">
            <a href="{{ route('orders.simples.index') }}" class="btn btn-warning">Quay lại</a>
