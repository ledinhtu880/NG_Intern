        ...
        <div class="tab-content">
              ...
              <div class="col-md-6">
                <div class="d-flex flex-column">
                  ...
                  <a href="{{ route('productStationLines.index') }}" class="btn btn-primary-color my-1 w-50">
                    Quản lý dây chuyền xử lý đơn hàng
                  </a>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="d-flex flex-column">
                  ...
                  <a href="{{ route('dispatch.index') }}" class="btn btn-primary-color my-1 w-50">Khởi động đơn hàng</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="tab-pane">
            <div class="row col-md-6">
              <div class="d-flex flex-column">
                <a href="{{ route('roles.index') }}" class="btn btn-primary-color my-1 w-50">
                  Quản lý vai trò
                </a>
                <a href="{{ route('users.index') }}" class="btn btn-primary-color my-1 w-50">
                  Quản lý người dùng
                </a>
              </div>
            </div>
