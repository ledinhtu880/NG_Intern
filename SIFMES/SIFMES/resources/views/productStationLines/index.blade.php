      ...
      <div class="col-md-12">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-color px-2 py-3 rounded">
            ...
            <li class="breadcrumb-item active" aria-current="page">Quản lý dây chuyền xử lý đơn hàng</li>
          </ol>
        </nav>
        <div class="card mt-3">
          <div class="card-header p-0 overflow-hidden">
            <h4 class="card-title m-0 bg-primary-color p-3">Quản lý dây chuyền xử lý đơn hàng</h4>
            <a href="{{ route('productStationLines.create') }}" class="btn btn-primary-color text-white py-2 px-5 m-3">
              Thêm dây chuyền xử lý đơn hàng
            </a>
          </div>
