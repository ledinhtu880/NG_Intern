                ...
                if (response == 0) {
                    ...
                    for (var i = 1; i <= col * row; i++) {
                        if (details[i - 1].FK_Id_StateCell == "1") {
                            ...
                            $('#cell' + i).attr("data-status", 0)
                            $('#cell' + i).append(
                                $(`<p class="small">Thùng hàng số ${details[i - 1].FK_Id_ContentSimple}
                                        ...
                                        data-bs-target="#show-${details[i - 1].FK_Id_ContentSimple}" data-id="${details[i - 1].FK_Id_ContentSimple}">
                                        <i class="fa-solid fa-eye"></i>
                                        </button>
                                    </p>`)
                            );
                            let modals = `
                            <div class="modal fade" id="show-${details[i - 1].FK_Id_ContentSimple
                                }" tabindex="-1"
                                    aria-labelledby="#show-${details[i - 1].FK_Id_ContentSimple
                                }Label" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                        <div class="modal-header p-2 bg-primary-color text-start" data-bs-theme="dark">
                                            <h5 class="modal-title w-100 " id="show-${details[i - 1].FK_Id_ContentSimple
                                }Label">
