      ...
      <div class="w-75">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-color px-2 py-3 rounded">
            ...
            <li class="breadcrumb-item active" aria-current="page">Thêm đơn đóng gói</li>
          </ol>
        </nav>
        <div class="card mb-2">
          <div class="card-header p-0 overflow-hidden">
            <h4 class="card-title m-0 bg-primary-color p-3">Gói hàng</h4>
          </div>
            ...
            <table class="table table-striped m-0">
              <thead id="table-heading">
                <tr>
                  ...
                  <th class="text-center" scope="col">Số lượng gói hàng</th>
                  <th class="text-center" scope="col">Giá gói hàng</th>
                </tr>
              </thead>
        ...
        <div class="card mb-2">
          <div class="card-header p-0 overflow-hidden">
            <h4 class="card-title m-0 bg-primary-color p-3">Đơn đóng gói</h4>
          </div>
          <div class="card-body px-0">
            <table class="table table-striped m-0">
              <thead>
              ...
              <tbody id="table-result" class="table-group-divider ">
        ...
        <div class="d-flex justify-content-end">
          <a href="{{ route('orderLocals.packs.index') }}" class="btn btn-primary-color px-4">Lưu</a>
        </div>
      </div>
    </div>
  </div>
