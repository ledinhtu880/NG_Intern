      ...
      <div class="card-body">
        <form method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" name="Name_ProdStationLine" id="Name_ProdStationLine" placeholder="Nhập tên dây chuyền"
              class="form-control" value="{{ $productStationLine->Name_ProdStationLine }}">
          ...
          <div class="form-group">
            ...
            <textarea name="Description" id="Description" placeholder="Nhập mô tả"
              class="form-control">{{ $productStationLine->Description }}</textarea>
          ...
          <div class="form-group">
            ...
            <select name="FK_Id_OrderType" id="FK_Id_OrderType" class="form-control ">
              ...
              <option value="{{ $orderType->Id_OrderType }}" @if ($orderType->Id_OrderType ==
                $productStationLine->FK_Id_OrderType) selected @endif>
