      ...
      <div class="w-50">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-color px-2 py-3 rounded">
            ...
            <li class="breadcrumb-item active" aria-current="page">Thêm dây chuyền xử lý đơn hàng</li>
          </ol>
        </nav>
        <div class="card mb-3">
          <div class="card-header p-0 overflow-hidden">
            <h3 class="card-title m-0 bg-primary p-3 text-white">Thêm dây chuyền</h3>
          </div>
          <div class="card-body">
            <form method="POST">
              @csrf
              <div class="form-group">
                ...
                <input type="text" name="Name_ProdStationLine" id="Name_ProdStationLine"
                  placeholder="Nhập tên dây chuyền" class="form-control" value="{{ old('Name_ProdStationLine') }}">
