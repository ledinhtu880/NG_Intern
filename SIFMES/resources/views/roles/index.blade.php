  ...
  <div class="col-md-12">
    <div class="card border-0 shadow-sm">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="border border-dark border-start-0 border-end-0">
              ...
              <ul class="list-group collapse cursor-pointer" id="collapseRole{{ $key }}" data-bs-parent="#accordion">
                @foreach ($roles as $role)
                @if ($role->FK_Id_RoleParent == $key)
                <li class="list-group-item">
                  <input class="form-check-input me-1 checkbox" type="checkbox" value="" id="role{{ $role->Id_Role }}">
      ...
      <div class="card-footer">
        <button class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#modalstart" id="btnSave">Lưu
          lại</button>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-primary" data-bs-dismiss="modal" id="confirm">Đồng
                  ý</button>
              </div>
            </div>
          </div>
