                                ...
                                @foreach ($data as $each)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href=" {{ route('orderLocals.expeditions.show', $each) }}"
                                                class="btn btn-sm text-secondary">
                                                <i class="fa-solid fa-eye"></i>
                                            </a>
                                            <a href="{{ route('orderLocals.expeditions.edit', $each) }}"
                                                class="btn btn-sm text-secondary">
                                            ...
                                            <div class="modal fade" id="deleteOrder-{{ $each->Id_OrderLocal }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form method="POST"
                                                                action="{{ route('orderLocals.expeditions.destroy', $each) }}">
                                                                @csrf
                                                                @method('DELETE')
