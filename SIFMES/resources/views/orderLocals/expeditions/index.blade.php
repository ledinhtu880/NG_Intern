...
@section('title', 'Quản lý đơn giao hàng')

@section('content')
<div class="row g-0 p-3">
  <div class="d-flex justify-content-between align-items-center">
    <h4 class="h4 m-0 fw-bold text-body-secondary">Quản lý đơn giao hàng</h4>
    <ol class="breadcrumb mb-0">
      <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('index') }}">Trang chủ</a>
      </li>
      <li class="breadcrumb-item active fw-medium" aria-current="page">Quản lý đơn giao hàng</li>
    </ol>
  </div>
</div>
<div class="container">
      ...
      <div class="card border-0 shadow-sm">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <a href="{{ route('orderLocals.expeditions.create')}}" class="btn btn-danger rounded-1">
              <i class="fa-solid fa-plus text-white me-3 fs-6"></i>
              <span>Thêm đơn giao hàng</span>
            </a>
          </div>
          <table class="table">
            ...
            <tbody id="table-data">
              ...
              <tr>
                ...
                <td class="text-center">
                  <a href=" {{ route('orderLocals.expeditions.show', $each) }}" class="btn btn-sm text-secondary">
                    <i class="fa-solid fa-eye"></i>
                  </a>
                  <a href="{{ route('orderLocals.expeditions.edit', $each) }}" class="btn btn-sm text-secondary">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <form method="POST" action="{{ route('orderLocals.expeditions.destroy', $each) }}">
                            @csrf
                            @method('DELETE')
