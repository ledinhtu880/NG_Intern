    ...
    <div class="card border-0 shadow-sm mb-3">
            ...
            <tr>
              ...
              <td class="text-center">
                <button type="button" class="btnShow btn btn-sm text-secondary" data-bs-toggle="modal"
                  data-bs-target="#show-{{ $each->Id_OrderLocal }}" data-id="{{ $each->Id_OrderLocal }}">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <table class="table table-details table-striped m-0">
                          ...
                          <tbody class="table-simples" class="p-5" data-value="{{ $each->Id_OrderLocal }}">
                          </tbody>
                        </table>
                      </div>
                    </div>
      ...
      <div class="card-footer d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center justify-content-end">
          <a href="{{ route('orderLocals.expeditions.index') }}" class="btn btn-lg btn-light px-3 fs-6">Quay lại</a>
        </div>
      </div>
    </div>
  </div>
