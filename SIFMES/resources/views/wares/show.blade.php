        ...
        <div class="row">
          ...
          <div class="col-2">
            <div class="input-group mb-3">
              ...
              <input type="number" class="form-control" min="1" id="rowNumber" name="rowNumber" readonly>
            </div>
          </div>
          <div class="col-2">
            <div class="input-group mb-3">
              <span class="input-group-text">Số cột</span>
              <input type="number" class="form-control" min="1" id="colNumber" name="colNumber" readonly>
            </div>
          </div>
        </div>
      </div>
          ...
          if (response == 0) {
            ...
            for (var i = 1; i <= row; i++) {
              ...
              for (var j = 1; j <= col; j++) {
                ...
                newCol.attr("id", "cell" + count)
                //newCol.text("Row " + i + ", Col " + j);
                var info = $('<p class="text-end position-absolute top-0 end-0 bg-transparent"></p>');
                info.text(i + '.' + j);
                newCol.append(info);
                newRow.append(newCol);
              }
