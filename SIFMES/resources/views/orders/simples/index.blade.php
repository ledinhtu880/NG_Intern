          ...
          <tbody id="table-data">
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="{{ route('orders.simples.show', $each) }}" class="btn btn-sm text-secondary">
                  <i class="fa-solid fa-eye"></i>
                </a>
                <a href="{{ route('orders.simples.edit', $each) }}" class="btn btn-sm text-secondary">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <form method="POST" action="{{ route('orders.simples.destroy', $each) }}">
                          @csrf
                          @method('DELETE')
