...
<div class="row g-0 p-3">
  <div class="col-md-12">
    <div class="card border-0 shadow-sm mb-3">
      <div class="card-header border-0 bg-white">
        <h5 class="card-title m-0 fw-bold text-body-secondary">Thông tin thùng hàng cần sản xuất mới</h5>
      </div>
      <div class="card-body border-0">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="input-group mb-3">
                <label class="input-group-text bg-secondary-subtle" for="FK_Id_RawMaterial" style="width: 140px;">
                  Nguyên vật liệu
                </label>
            ...
            <div class="col-md-4">
              <div class="input-group mb-3">
                <label class="input-group-text bg-secondary-subtle" for="FK_Id_ContainerType" style="width: 140px;">
                  Thùng chứa
                </label>
            ...
            <div class="col-md-4">
              <div class="input-group mb-3">
                ...
                <input type="number" name="Price_Container" id="Price_Container" class="form-control" step="0.01"
                  min="1" value='1'>
              </div>
            </div>
          </div>
        ...
        <table class="table mt-4">
          ...
          <tbody id="table-data">
            ...
            <tr data-id="{{ $each->Id_ContentSimple }}">
              ...
              <td class="text-center" data-id="Status" data-value="{{ $each->Status == 'Lấy từ kho' ? 1 : 0 }}">
                {{ $each->Status }}
              </td>
      ...
      <div class="card-footer">
        <div class="d-flex align-items-center justify-content-end gap-3">
          <button class="btn btn-lg btn-light px-3 fs-6" id="backBtn">Quay lại</button>
          <a href="{{ route('orders.simples.index') }}" class="btn btn-lg btn-primary px-3 fs-6" id="saveBtn">Lưu</a>
        </div>
      </div>
    </div>
  </div>
