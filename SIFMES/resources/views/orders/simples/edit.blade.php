              ...
              <div class="row">
                <div class="col-md-12 mb-3">
                  <div class="input-group">
                    <label class="input-group-text bg-secondary-subtle" for="FK_Id_Customer" style="width: 130px;">Khách
                      hàng</label>
            ...
            <table class="table">
              ...
              <tbody id="table-data">
                ...
                <tr class="js-row" data-id="{{ $each->Id_ContentSimple }}">
                  <td>
                    <select class="form-select selectValidate" style="width: 150px" id="FK_Id_RawMaterial"
                  ...
                  <td data-name="unit">{{ $each->Unit}}</td>
                  <td>
                    <select class="form-select selectValidate" style="width: 150px" id="FK_Id_ContainerType"
...
<script>
  $(document).ready(function () {
    $(".js-row").each(function (index, element) {
      ...
      let isCountContainer = $(element).find("input[name='Count_Container']").length > 0;

      if (isMake == 1) {
        $(element).find("select").prop("disabled", true);
        $(element).find("input").prop("disabled", true);
        $(element).find("input[name='Count_Container']").prop("disabled", false)
      }
    });
  });
</script>
