            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <textarea class="form-control" id="Note" style="height: 91px;" aria-label="Notes" name="Note"
                  rows="5">{{ isset($information) ? $information->Note : $order->Note }}</textarea>
              </div>
            </div>
          </div>
        </form>
            ...
            <tr class="js-row" data-id="{{ $each->Id_ContentPack }}">
              <form method="POST">
                ...
                <td class="text-center input-group">
                  <input type="number" class="form-control Count_Pack" id="Count_Pack" value="{{ $each->Count_Pack }}"
                    min="1" name="Count_Pack" required>
