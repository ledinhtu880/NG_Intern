...
<div class="row g-0 p-3">
  <div class="d-flex justify-content-between align-items-center">
    <h4 class="h4 m-0 fw-bold text-body-secondary">Quản lý đơn gói hàng</h4>
    ...
    <div class="card border-0 shadow-sm">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <a href="{{ route('orders.packs.create') }}" class="btn btn-danger rounded-1">
          ...
          <tbody id="table-data">
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="{{ route('orders.packs.show', $each->Id_Order) }}" class="btn btn-sm text-secondary">
                  <i class="fa-solid fa-eye"></i>
                </a>
                <a href="{{ route('orders.packs.edit', $each->Id_Order) }}" class="btn btn-sm text-secondary">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        Bạn có chắc chắn về xóa đơn gói hàng này?
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                        <form method="POST" action="{{ route('orders.packs.destroy', $each->Id_Order) }}">
                          @csrf
                          @method('DELETE')
