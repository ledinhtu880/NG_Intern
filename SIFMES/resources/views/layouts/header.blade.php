<div class="navbar-custom bg-white">
  ...
  <ul class="d-flex list-unstyled m-0 p-0">
    <li class="dropdown notification-list">
      <button type="button" class="nav-link dropdown-toggle h-100" data-bs-toggle="dropdown" data-bs-display="static"
        aria-expanded="false">
    ...
    <li class="dropdown notification-list">
      <a class="nav-link nav-user py-3 px-2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
