          ...
          <div class="card-body">
            <table class="table table-bordered">
              ...
              <tbody class="table-group-divider ">
                ...
                <tr>
                  <th class="text-center ">{{ $each->Id_PackContent }}</th>
                  ...
                  <td class="text-center ">
                    ...
                    <button type="button"
                      ...
                      data-bs-toggle="modal" data-id="{{ $each->Id_PackContent }}"
                      data-bs-target="#i{{ $each->Id_PackContent }}">
                      <i class="fa-solid fa-eye"></i>
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="i{{ $each->Id_PackContent }}" data-bs-backdrop="static"
