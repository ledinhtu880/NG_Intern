        ...
        <div class="w-100">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-color px-2 py-3 rounded">
              ...
              <li class="breadcrumb-item active">
                <a class="text-decoration-none" href="{{ route('tracking.orderlocals.index') }}">Theo dõi đơn hàng nội bộ</a>
              </li>
          ...
          <div class="card">
            ...
            <div class="card-footer d-flex align-items-center justify-content-end mt-3">
              <a href="{{ route('tracking.orderlocals.index') }}" class="btn btn-lg btn-primary-color px-4">
                Quay lại
              </a>
            </div>
          </div>
  ...
  <script>
    $(document).ready(function() {
      $(".btn-detail").on('click', function() {
        ...
        $.ajax({
          url: '/tracking/orderlocals/detailSimpleOfPack',
          type: 'POST',
          data: {
