                        ...
                        <div class="card-body">
                            ...
                            ">
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('tracking.orderlocals.showDetailsSimple', $each->Id_SimpleContent)}}" target="_blank" class="btn btn-sm btn-outline-light text-primary-color border-secondary btn-detail"><i class="fa-solid fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        @php
                                            $count++;
